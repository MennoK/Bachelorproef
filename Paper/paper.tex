...
\begin{algorithm}
  \caption{Activiteit van een deel van een sequentie bepalen, met een gegeven lijst van overlappende tijdsvensters en een ruis cutoff percentage}
  \label{alg:deel}
  \begin{algorithmic}[0]
    \Procedure{activiteit}{$vensters, cutoff$}
      ...
      \Else
        \If{$kansen$[$i$] $\le$ $cutoff$ voor alle $i$}
